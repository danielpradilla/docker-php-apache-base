...
* Enabled PHP extensions: gd, mcrypt, intl, mysql, mysqli, pdo_mysql, psql, pdo_psql, mbstring, soap, opcache, zip, xls
...
Standalone usage example with host's current working directory as document root:
	...
	$ docker run -p 80:80 -v $(pwd):/var/www/html danielpradilla/php-apache-base
